...
<body>
    <!-- 顶部标题栏 -->
    <%
    request.setAttribute("pageTitle", "智慧医疗云系统 - 高校用户");
    request.setAttribute("userWelcome", "欢迎，高校用户");
    request.setAttribute("logoutLink", basePath + "login/academic-login.jsp");
    %>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.nav-sub-item a').forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    // 使用通用加载函数
                    loadBusinessContent('university', group, contentId);
