...
<body>
    <!-- 顶部标题栏 -->
    <%
    request.setAttribute("pageTitle", "智慧医疗云系统 - 企业用户");
    request.setAttribute("userWelcome", "欢迎，企业用户");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.nav-sub-item a').forEach(link => {
                link.addEventListener('click', function(e) {
                    ...
                    // 使用通用加载函数
                    loadBusinessContent('enterprise', group, contentId);
